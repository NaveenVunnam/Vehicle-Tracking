...
\subsection{\texorpdfstring{\href{https://review.udacity.com/\#!/rubrics/513/view}{Rubric}
...
\hypertarget{video-implementation}{%
\subsubsection{Video Implementation}\label{video-implementation}}

\hypertarget{provide-a-link-to-your-final-video-output.-your-pipeline-should-perform-reasonably-well-on-the-entire-project-video-somewhat-wobbly-or-unstable-bounding-boxes-are-ok-as-long-as-you-are-identifying-the-vehicles-most-of-the-time-with-minimal-false-positives.}{%
\paragraph{Provide a link to your final video output. Your pipeline
should perform reasonably well on the entire project video (somewhat
wobbly or unstable bounding boxes are ok as long as you are identifying
the vehicles most of the time with minimal false
positives.)}\label{provide-a-link-to-your-final-video-output.-your-pipeline-should-perform-reasonably-well-on-the-entire-project-video-somewhat-wobbly-or-unstable-bounding-boxes-are-ok-as-long-as-you-are-identifying-the-vehicles-most-of-the-time-with-minimal-false-positives.}}

Here's a \href{./project_video_output.mp4}{link to my video result}
...
For this project I have spent a lot of time on selecting the best
combination of HOG parameters. After selecting the best combination I
have worked on selecting different scales and overlapping values for
windows. There are lot of false positives detected on the left side of
the car where shadows and different lighting conditions other than the
ones from training set. This issue can be resolved by adding more dark
images to the training data set. I would like try the same project using
deep learning and will update you I got any better results.
